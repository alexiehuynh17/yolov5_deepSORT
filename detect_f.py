        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    bb_left = min(xyxy[0].item(), xyxy[2].item())
                    bb_top = min(xyxy[1].item(), xyxy[3].item())
                    bb_w = abs(xyxy[0].item() - xyxy[2].item())
                    bb_h = abs(xyxy[1].item() - xyxy[3].item())
                    box = [bb_left, bb_top, bb_w, bb_h]
                    bboxes.append(box)
